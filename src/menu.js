...
export function menu(){
    ...
    let menuItem = [    //an array to store food items, no need to set variables for each item and makes it easier to add more items later on. 
        {
            name: `borgir | 50`,
            des: `tastes good`
        },
    ...
    menuItem.forEach(element => {   //loop over each object in the menuItem array.
        const menuList = document.createElement("ul");
        Object.values(element).forEach(saidItem => {    //loop over the elements of each object and append them corr.
